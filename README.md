...
| **claude-skills-pro** | 15 engineering-workflow skills (7-dimension code review, root-cause bug hunting, test generation with mutation check, zero-downtime DB migrations, security audit) — 7 free under MIT, CN handbook included | [Source](https://github.com/Hahaknight/claude-skills-pro) |
...
| **i-hate-editing** | Local talking-head cuts via whisper.cpp + ffmpeg + craft rules (model never watches the pixels) | [Source](https://github.com/ranahaani/i-hate-editing) |
