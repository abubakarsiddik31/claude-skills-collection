...
| **claude-skills-pro** | 15 engineering-workflow skills (7-dimension code review, root-cause bug hunting, test generation with mutation check, zero-downtime DB migrations, security audit) — 5 free under MIT, CN handbook included | [Source](https://github.com/Hahaknight/claude-skills-pro) |
